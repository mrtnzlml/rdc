class Rdc < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mrtnzlml/rdc/releases/download/v0.1.0/rdc-aarch64-apple-darwin.tar.gz"
      sha256 "ff0d71c63446cdd60d9fe463e4c6ef16f5aad27e8adf2e77a83c92f7c62268e3"
    end
    on_intel do
      url "https://github.com/mrtnzlml/rdc/releases/download/v0.1.0/rdc-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/mrtnzlml/rdc/releases/download/v0.1.0/rdc-x86_64-unknown-linux-gnu.tar.gz"
